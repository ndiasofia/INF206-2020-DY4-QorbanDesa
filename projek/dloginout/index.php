        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
              <div class="navbar-nav">
                  <a class="nav-link active fw-bolder text-muted aria-current=page" href="#">Home</a>
                  <a class="nav-link fw-bolder text-muted" href="#">Hukum Qurban</a>
                  <a class="nav-link fw-bolder text-muted" href="#">Tentang Kami</a>
