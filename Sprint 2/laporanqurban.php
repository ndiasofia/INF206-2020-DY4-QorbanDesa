...
//menyiapkan query
$sql ="SELECT tanggal, nama_sq, nama_hewan, harga, bukti_pembayaran, keterangan  FROM data_pengqurban WHERE no_hp_p=:no_hp_p";

$stmt = $db->prepare($sql);
$stmt->bindParam(':no_hp_p', $no_hp_p, PDO::PARAM_STR); 
$stmt->execute();
